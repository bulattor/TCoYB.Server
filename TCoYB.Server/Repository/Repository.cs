...
namespace TCoYB.Server.Repository
{
    public class Repository : IRepository
    {
        ...
        {
            return Context.AppUsers.Include(u => u.FoodItems).Include(u => u.UserToken).FirstOrDefault(u => u.Username == username);
        }

        public void UpdateUser(AppUser user)
        {
            AppUser? toUpdate = Context.AppUsers.Include(u => u.FoodItems).Include(u => u.UserToken).FirstOrDefault(u => u.Username == user.Username);
            if(toUpdate != null)
            {
